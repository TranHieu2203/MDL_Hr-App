...
@Component({
  selector: 'mdl-input',
  templateUrl: './mdl-input.component.html',
  styleUrls: ['./mdl-input.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => MdlInputComponent),
      multi: true
    },
  ]

})
export class MdlInputComponent implements ControlValueAccessor {
