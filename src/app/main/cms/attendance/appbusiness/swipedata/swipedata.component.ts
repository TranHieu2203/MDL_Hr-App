...
export class swipedataComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/swipedata/GetAll", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/swipedata/GetAll', extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
