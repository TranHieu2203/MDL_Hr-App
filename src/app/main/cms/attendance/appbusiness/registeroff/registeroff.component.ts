...
export class RegisterOffComponent implements OnInit, OnDestroy {
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/RegisterOff/GetAllRegisterOff", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      ...
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/RegisterOff/GetAllRegisterOff', extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "quanlydangkynghi" + "-" + formattedDate + ".xlsx"
          };
