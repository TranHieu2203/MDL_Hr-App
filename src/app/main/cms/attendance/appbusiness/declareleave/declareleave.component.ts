...
export class DeclareleaveComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/attendance/business/declareleave/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/entitlement/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        ...
        this.router.navigate(["/hrms/attendance/business/declareleave/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate([
            "/hrms/attendance/business/declareleave/",
            paramAdd,
          ]);
        } else {
      ...
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/entitlement/GetAll', extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "khaibaodieuchinhphepbu" + "-" + formattedDate + ".xlsx"
          };
              ...
              if (response.status == 204) {
                ...
                if (response.body!.type == "application/json") {
                  ...
                  if (binaryData.length > 0) {
                    ...
                    downloadLink.click();
                    this.notification.warning(
                      "Import không thành công! bạn vui lòng kiểm tra lại file ImportPhepNamError.xlsx!"
                    );
                  }
                }
              }
