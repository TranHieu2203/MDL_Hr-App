...
import { SalaryType } from "src/app/_models/app/cms/index";
...
export class SalaryTypeEditComponent implements OnInit {
  ...
  loadData() {
    if (this.paramId) {
      this._coreService
        .Get("hr/SalaryType/get?id=" + this.paramId)
        .subscribe((res: any) => {
          this.model = res.data;
        });
    } else{
    ...
    switch (buttonId) {
      case ToolbarItem.BACK:
        ...
        if (this.flagePopup === true) {
          this.router.navigate(["hrms/profile/list/salarytype"]);
        }
        break;
