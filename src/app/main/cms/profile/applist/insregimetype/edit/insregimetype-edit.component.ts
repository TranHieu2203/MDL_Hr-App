...
import { InsRegimeType } from "src/app/_models/app/cms/index";
...
@Component({
  selector: "app-insregimetype-edit",
  templateUrl: "./insregimetype-edit.component.html",
  styleUrls: ["./insregimetype-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class InsRegimeTypeEditComponent implements OnInit {
    ...
    async.waterfall(
      [
        (cb: any) => {
          if (this.paramId) {
            this._coreService
              .Get("hr/insregimetype/get?id=" + this.paramId)
              .subscribe((res: any) => {
    ...
    switch (buttonId) {
      case ToolbarItem.BACK:
        ...
        if (this.flagePopup === true) {
          this.router.navigate(["hrms/profile/list/insregimetype"]);
        }
        break;
  ...
  saveData = () => {
    ...
    if (this.flagState$.value === "new") {    
      this._coreService.Post("hr/insregimetype/add", param).subscribe(
        (res: any) => {
      ...
      this._coreService.Post("hr/insregimetype/Update", param).subscribe(
        (res: any) => {
          if (res.statusCode == 400) {
            this.notification.checkErrorMessage(res.message);
          } else {
