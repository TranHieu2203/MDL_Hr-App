...
import { Job } from "src/app/_models/app/hrms/profile/applist/jobBand";
import { JobFunction } from "src/app/_models/app/hrms/profile/applist/jobBand";
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.BACK:
        ...
        this.router.navigate(["cms/organize/business/job"]);
        break;
    ...
    this._coreService.Post("hr/job/update", param).subscribe(
      (res: any) => {
        ...
        if (res.statusCode == 400) {
          ...
          this.router.navigate(["/hrms/organize/business/job"]);
        }
      },
      (error: any) => {
