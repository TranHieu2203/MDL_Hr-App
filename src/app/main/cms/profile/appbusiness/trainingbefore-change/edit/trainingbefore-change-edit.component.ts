...
import {  TrainingBefore } from "src/app/_models/app/cms/index";
...
@Component({
  selector: "app-trainingbefore-change-edit",
  templateUrl: "./trainingbefore-change-edit.component.html",
  styleUrls: ["./trainingbefore-change-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class TrainingBeforeChangeEditComponent implements OnInit {
  ...
  modelTemp: TrainingBefore = new TrainingBefore();
  modelCompare: TrainingBefore = new TrainingBefore();
  languages: any;
    ...
    this.activatedRoute.params.subscribe((params: Params) => {
      ...
      if (paramId !== "new") {
        ...
        if (paramUrl && paramUrl.id) {
          ...
          this.paramIdTraining = paramUrl.idTraining;
    ...
    async.waterfall(
      [
        (cb: any) => {
          if (this.paramId) {
            this._coreService
              .Get("hr/Employee/GetTrainingBeforeEditById?id=" + this.paramId)
              .subscribe((res: any) => {
        ...
        (cb: any) => {
          if (this.paramIdTraining) {
            this._coreService
              .Get("hr/Employee/GetTrainingBeforeById?id=" + this.paramIdTraining)
              .subscribe((res: any) => {
        ...
        (cb: any) => {
          this._coreService
            .Get("hr/otherlist/CERTIFICATE_TYPE")
            .subscribe((res: any) => {
        ...
        (cb: any) => {
          this._coreService
            ...
            .subscribe((res: any) => {
              this.lstFormTrain = res.data;
              cb();
            });
        },
        (cb: any) => {
          this._coreService
            .Get("hr/otherlist/SPECIALIZED_TRAIN")
            .subscribe((res: any) => {
              this.lstSpecialized = res.data;
              cb();
            });
        },
      ],
    ...
    switch (buttonId) {
      ...
      case ToolbarItem.BACK:
        ...
        if (this.flagePopup === true) {
          this.router.navigate(["hrms/profile/business/trainingbefore-change"]);
        }
        break;
