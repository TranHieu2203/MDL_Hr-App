...
@Component({
  selector: "cms-profile-leavejobsettlement",
  templateUrl: "./leavejobsettlement.component.html",
  styleUrls: ["./leavejobsettlement.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class LeaveJobSettlementComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate([
      "/hrms/profile/business/leavejobsettlement/",
      paramAdd,
    ]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/terminate/GetAllQT", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/hrms/profile/business/leavejobsettlement/new"]);
        break;
