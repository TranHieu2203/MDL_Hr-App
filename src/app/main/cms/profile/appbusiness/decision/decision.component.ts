...
export class DecisionComponent implements OnInit {
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/working/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        ...
        this.router.navigate(["/hrms/profile/business/decision/new"]);
        break;
      ...
      case ToolbarItem.SYNC:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          if (lstDeleteIds.length > 0) {
            this._coreService
              .Post("hr/working/PushErpWorking", lstDeleteIds)
      ...
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/working/GetAll', extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "quyetdinhthaydoi" + "-" + formattedDate + ".xlsx"
          };
