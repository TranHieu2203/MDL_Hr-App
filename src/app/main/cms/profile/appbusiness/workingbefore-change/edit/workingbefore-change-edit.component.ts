...
import {  WorkingBefore } from "src/app/_models/app/cms/index";
...
@Component({
  selector: "app-workingbefore-change-edit",
  templateUrl: "./workingbefore-change-edit.component.html",
  styleUrls: ["./workingbefore-change-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class WorkingBeforeChangeEditComponent implements OnInit {
  ...
  modelTemp: WorkingBefore = new WorkingBefore();
  modelCompare: WorkingBefore = new WorkingBefore();
  languages: any;
    ...
    this.activatedRoute.params.subscribe((params: Params) => {
      ...
      if (paramId !== "new") {
        ...
        if (paramUrl && paramUrl.id) {
          ...
          this.paramIdWorking = paramUrl.idWorking;
    ...
    async.waterfall(
      [
        (cb: any) => {
          if (this.paramId) {
            this._coreService
              .Get("hr/Employee/GetWorkingBeforeEditById?id=" + this.paramId)
              .subscribe((res: any) => {
        ...
        (cb: any) => {
          if (this.paramIdWorking) {
            this._coreService
              .Get("hr/Employee/GetWorkingBeforeById?id=" + this.paramIdWorking)
              .subscribe((res: any) => {
    ...
    switch (buttonId) {
      ...
      case ToolbarItem.BACK:
        ...
        if (this.flagePopup === true) {
          this.router.navigate(["hrms/profile/business/workingbefore-change"]);
        }
        break;
