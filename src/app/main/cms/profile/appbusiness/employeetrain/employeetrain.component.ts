...
@Component({
  ...
  templateUrl: "./employeetrain.component.html",
  styleUrls: ["./employeetrain.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class EmployeetrainComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  ngOnInit(): void {
    ...
    this.model.startDate = (moment(new Date()).format("DD/MM/YYYY"))
    this.model.endDate = (moment(new Date()).format("DD/MM/YYYY"))
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/employeetrain/GetEmployeeTrain", extraParams);
  };
  ...
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    let extraParams: any = [
      ...
      {
        field: "startDate",
        value: moment(this.model.startDate).format("MM/DD/YYYY"),
      },
      {
        field: "endDate",
        value: moment(this.model.endDate).format("MM/DD/YYYY"),
      },
    ];
    this._coreService.execute(this.state, "hr/employeetrain/GetEmployeeTrain", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/employeetrain/GetEmployeeTrain',extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
