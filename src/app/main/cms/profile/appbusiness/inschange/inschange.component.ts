...
import { ToolbarItem, ToolbarInterface, InsChange } from "src/app/_models/index";
...
export class InsChangeComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/profile/business/inschange/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/inschange/GetAll", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/hrms/profile/business/inschange/new"]);
        break;
      ...
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/inschange/GetAll',extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "biendongbaohiem" + "-" + formattedDate + ".xlsx"
          };
      ...
      case ToolbarItem.PRINT:
        if (this.model.changeMonth == undefined) {
          this.notification.warning("Chưa chọn tháng biến động!");
          return;
        }
        let orgId = this.nodeSelected;
        let IsDissolve = 0;

        let paramExport = {
          orgId: orgId,
          changeMonth: this.model.changeMonth
        }
        this._coreService
          .templateImportV2Hrm("PrintReportInsuranceChange", paramExport)
          .subscribe((res: any) => {
      ...
      case ToolbarItem.EXPORT_TEMPLATE:
        ...
        this._coreService
          .templateImportV2Hrm("PrintReportInsuranceChangeLD", paramExport1)
          .subscribe((res: any) => {
            ...
            .subscribe((response: HttpResponse<Blob>) => {
              ...
              if (response.status == 204) {
                this.notification.error(
                  "Import không thành công! bạn vui lòng kiểm tra lại!"
                );
              } else {
                if (response.body!.type == "application/json") {
                  ...
                  if (binaryData.length > 0) {
                    ...
                    this.notification.warning(
                      "Import không thành công! bạn vui lòng kiểm tra lại file TempInsuranceError.xlsx!"
                    );
                  }
                }
              }
