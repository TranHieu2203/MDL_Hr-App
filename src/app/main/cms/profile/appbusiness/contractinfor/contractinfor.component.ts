...
export class ContractInforComponent implements OnInit, OnDestroy {
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/contract/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        ...
        this.router.navigate(["/hrms/profile/business/contractinfor/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate([
            "/hrms/profile/business/contractinfor/",
            paramAdd,
          ]);
        } else {
      ...
      case ToolbarItem.PRINT:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          this._coreService
            .templateImportV2Hrm("PrintContract", paramExport)
            .subscribe((res: any) => {
      ...
      case ToolbarItem.PRINT_JD_POSITION:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          this._coreService
            .templateImportV2Hrm("GetPrintContractProbaReview", paramExport)
            .subscribe((res: any) => {
      ...
      case ToolbarItem.SYNC:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          if (lstDeleteIds.length > 0) {
            this._coreService
              .Post("hr/contract/PushErpContract", lstDeleteIds)
      ...
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/contract/GetAll', extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "thongtinhopdong" + "-" + formattedDate + ".xlsx"
          };
