...
@Component({
  selector: "cms-profile-recruitmentplan",
  templateUrl: "./recruitmentplan.component.html",
  styleUrls: ["./recruitmentplan.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class RecruitmentPlanComponent implements OnInit, OnDestroy {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/profile/business/recruitmentplan/", paramAdd]);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        ...
        this.router.navigate(["/hrms/profile/business/recruitmentplan/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate([
            "/hrms/profile/business/recruitmentplan/",
            paramAdd,
          ]);
        } else {
  ...
  confirmDelete = (status: any): void => {
    if (status === "cancel") {
      ...
      if (this.modelDelete.length > 0) {
        ...
        this._coreService
          .Post("hr/recruitmentplan/remove", ids)
          .subscribe((res: any) => {
