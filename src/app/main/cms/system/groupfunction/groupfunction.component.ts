...
export class GroupFunctionComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/system/groupfunction/", paramAdd]);
  };
  ...
  searchAdvanceFilter = (): void => {
    ...
    setTimeout(() => {
      this._coreService.execute(this.state, "app-item/search", extraParams);
    }, 500);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "author/groupfunction/getall");
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/hrms/system/groupfunction/new"]);
        break;
