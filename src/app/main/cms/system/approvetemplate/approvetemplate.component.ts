...
export class ApproveTemplateComponent implements OnInit {
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "tenant/approvetemplate/getapprovetemplate");
  };
  ...
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    let extraParams: any[] = [];
    this._coreService.execute(this.state, "tenant/approvetemplate/getapprovetemplate", extraParams);
  }
  // Số thứ tự
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/hrms/system/approvetemplate/edit/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          const objParamAdd = { templateId: this.modelAdd.id };
          const paramAdd = window.btoa(JSON.stringify(objParamAdd));
          this.router.navigate(["/hrms/system/approvetemplate/edit/", paramAdd]);
        } else {
