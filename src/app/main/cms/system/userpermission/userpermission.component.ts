...
export class UserPermissionComponent implements OnInit {
  ...
  checkAllButton(field: string, event: any) {
    ...
    for (const item of this.data) {
      ...
      item.isSendMail = this.isSendMailColumnChecked;
  ...
  getPermissionSelect(id: any) {
    return new Promise((resolve) => {
      this._coreService
        .Get("hr/Setting/ListUserPermission?Id=" + id)
        .subscribe((res: any) => {
          resolve(res.data);
        });
    });
  ...
  getPermissionReport(id: any) {
    return new Promise((resolve) => {
      this._coreService
        .Post("hr/Setting/GetUserReport?userId=" + id, {})
        .subscribe((res: any) => {
          resolve(res.data);
        });
    });
  ...
  getTenantUser() {
    return new Promise((resolve) => {
      this._coreService.Get("tenant/GetListByTenant").subscribe((res: any) => {
        resolve(res);
      });
    });
  }
  ...
  getListData = (id?: any): void => {
    ...
    this._coreService
      .GetAll(state, "tenant/userpermission/GridFuntion", extraParams)
      .subscribe((res: any) => {
    ...
    switch (buttonId) {
      ...
      case ToolbarItem.SAVE:
        ...
        if (this.tab == 1) {
          ...
          this._coreService
            .Post("tenant/userpermission/Update", y)
            .subscribe((res: any) => {
          ...
          let a = {
            UserId: this.nodeSelected,
            OrgIds: checkIds,
          };

          this._coreService
            .Post("hr/Setting/Update", a)
            .subscribe((res: any) => {
              if (res.statusCode == 400) {
                this.notification.checkErrorMessage(res.message);
              } else {
          ...
          this._coreService
            .Post("hr/Setting/UpdateUserReport", param)
            .subscribe((res: any) => {
              if (res.statusCode == 400) {
                this.notification.checkErrorMessage(res.message);
              } else {
