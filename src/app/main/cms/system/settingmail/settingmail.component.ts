...
@Component({
  selector: "cms-app-settingmail",
  templateUrl: "./settingmail.component.html",
  styleUrls: ["./settingmail.component.scss"],
...
export class SettingMailComponent implements OnInit {
  ...
  arrayData: Array<SettingMail> = new Array<SettingMail>();
  ...
  loadData() {
    this._coreService.Get("hr/FormList/GetListSettingMail").subscribe((res: any) => {
      res.data[4].value = null;
  ...
  saveData = () => {
    ...
    this._coreService
      .Post("hr/FormList/UpdateSettingMail", this.arrayData)
      .subscribe((res: any) => {
        //check error
