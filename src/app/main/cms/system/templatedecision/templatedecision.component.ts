...
@Component({
  selector: "cms-app-TemplateDecision",
  templateUrl: "./templatedecision.component.html",
  styleUrls: ["./templatedecision.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class TemplateDecisionComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/system/templatedecision/", paramAdd]);
  };

  // Build Toolbar
  buildToolbar = () => {
    const toolbarList = [ToolbarItem.LOCK];
    this.toolbar = this.globals.buildToolbar("sys-app-TemplateDecision", toolbarList!);
  };

  // GetListData
  getListData = (): void => {
    
    this._coreService.execute(this.state, "author/templatedecision/getall");
  };
  ...
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    let extraParams: any[] = [];
    this._coreService.execute(this.state, "author/templatedecision/getall", extraParams);
  }
  // Số thứ tự
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        ...
        this.router.navigate(["/hrms/system/templatedecision/new"]);
        break;
      ...
      case ToolbarItem.LOCK:
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          this._coreService
            .Post("author/TemplateDecision/changestatus", ids)
            .subscribe((res: any) => {
