...
export class UserComponent implements OnInit {
  toolItems$ = new BehaviorSubject<any[]>([
    ToolbarItem.ADD, ToolbarItem.EDIT, ToolbarItem.LOCK, ToolbarItem.EXPORT_EXCEL, ToolbarItem.EXPORT_BC
  ])
  // Varriable Language
  languages: any;
  ...
  getListData = (groupId: any): void => {
    ...
    this._coreService.execute(this.state, "tenant/GetUser", extraParams);
  };
  getListData1 = (): void => {
    ...
    switch (buttonId) {
      ...
      case ToolbarItem.EXPORT_BC:
        ...
        this._coreService
          ...
          this._coreService
          .templateImportV2Hrm("getuserencryppass", paramExport)
          .subscribe((res: any) => {
