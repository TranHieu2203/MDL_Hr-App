...
import { ReportDynamic } from "src/app/_models/app/list/index";
...
@Component({
  selector: "app-reportdynamic-edit",
  templateUrl: "./reportdynamic-edit.component.html",
  styleUrls: ["./reportdynamic-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class ReportDynamicEditComponent implements OnInit {
    ...
    async.waterfall(
      [
        (cb: any) => {
          if (this.paramId) {
            this._coreService
              .Get("package/reportdynamic/get?id=" + this.paramId)
              .subscribe((res: any) => {
