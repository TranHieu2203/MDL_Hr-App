...
@Component({
  selector: "cms-attendance-payrollformula",
...
export class PayrollFormulaComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/payroll/setting/payrollformula/", paramAdd]);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/payroll/setting/payrollformula/new"]);
        break;
      case ToolbarItem.EXPORT_EXCEL:
        var data = this._coreService.ExecuteToExport('hr/salarytype/GetAll','',this.state).subscribe((res: any) => {
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "congthuctinhluong" + "-" + formattedDate + ".xlsx"
          };
      ...
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate([
            "/cms/payroll/setting/payrollformula/",
            paramAdd,
          ]);
        } else {
