...
import { CompetencySum } from "src/app/_models/app/cms";
import * as moment from "moment";
setCulture("en");
const $ = require("jquery");
@Component({
  selector: "cms-capacity-competencysum",
  templateUrl: "./competencysum.component.html",
  styleUrls: ["./competencysum.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class CompetencySumComponent implements OnInit, OnDestroy {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/capacity/business/competencysum/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/compentencysum/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.CREATECOMPENTENCY:
        ...
        if (this.model.periodId != null) {
          this._coreService
            .Post("hr/compentencysum/Create", param)
            .subscribe((res: any) => {
      ...
      case ToolbarItem.SEND:
        ...
        if (this.model.periodId != null) {
          this._coreService
            .Post("hr/compentencysum/SendPerform", param1)
            .subscribe((res: any) => {
              if (res.statusCode == 200) {
      ...
      case ToolbarItem.SUM_WORK:
        ...
        if (this.model.periodId != null) {
          this._coreService
            .Post("hr/compentencysum/Calculate", param2)
            .subscribe((res: any) => {
      ...
      case ToolbarItem.PRINT:
        ...
        if (selectDeletes && selectDeletes.length > 0) {
          if (selectDeletes && selectDeletes.length > 1) {
            ...
            this._coreService
              .templateImportV2Hrm("PrintCompetency", paramExport)
              .subscribe((res: any) => {
        ...
        case ToolbarItem.EXPORT_BC:
          ...
          if (this.model.periodId != null) { 
              ...
              this._coreService
                .templateImportV2Hrm("PrintCompentencyReport", paramExport)
                .subscribe((res: any) => {
      ...
      case ToolbarItem.EXPORT_EXCEL:
        ...
        var data = this._coreService.ExecuteToExport('hr/compentencysum/GetAll', extraParams, this.state).subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "khoitaovatonghopketqua" + "-" + formattedDate + ".xlsx"
          };
  ...
  confirmDelete = (status: any): void => {
    if (status === "cancel") {
      ...
      if (this.modelDelete.length > 0) {
        ...
        if (this.model.periodId != null) {
          this._coreService
            .Post("hr/compentencysum/Cancel", param2)
            .subscribe((res: any) => {
  ...
  changeYear() {
    this._coreService
      .Get("hr/competencyperiod/getlist?year=" + this.model.year)
      .subscribe((res: any) => {
