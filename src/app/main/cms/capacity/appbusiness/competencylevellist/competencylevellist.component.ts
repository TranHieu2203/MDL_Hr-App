...
@Component({
  ...
  templateUrl: "./competencylevellist.component.html",
  styleUrls: ["./competencylevellist.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class CompetencyLevelListComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/CompetencyLevel/GetLevelTranslate", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.EXPORT_EXCEL:
        var data = this._coreService.ExecuteToExport('hr/CompetencyLevel/GetLevelTranslate').subscribe((res: any) => {
          // Lấy ngày hiện tại
          ...
          const exportProperties: ExcelExportProperties = {
            dataSource: res.data,
            columns: [],
            fileName: "tudiennangluc" + "-" + formattedDate + ".xlsx"
          };
