...
export class InternalBlogComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/media/business/internalblog", paramAdd]);
  };

  getListData = (): void => {
    
    this._coreService.execute(this.state, "hr/BlogInternal/GetAll");
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    this.state = state;
    this.pageIndex = Math.floor(state.skip! / state.take!);
    let extraParams: any[] = [];
    this._coreService.execute(this.state, "hr/BlogInternal/GetAll", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/hrms/media/business/internalblog/new"]);
        break;
