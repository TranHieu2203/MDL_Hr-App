...
@Component({
  selector: "cms-recruitment-planreg",
  templateUrl: "./planreg.component.html",
  styleUrls: ["./planreg.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class PlanRegComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/hrms/recruitment/business/planreg/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "hr/planreg/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        ...
        this.router.navigate(["/hrms/recruitment/business/planreg/new"]);
        break;
      ...
      var data = this._coreService.ExecuteToExport('hr/planreg/GetAll', extraParams, this.state).subscribe((res: any) => {
        // Lấy ngày hiện tại
        ...
        const exportProperties: ExcelExportProperties = {
          dataSource: res.data,
          columns: [],
          fileName: "dinhbiennhansu" + "-" + formattedDate +".xlsx"
        };
