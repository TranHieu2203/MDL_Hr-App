...
import { GroupCriteria } from "src/app/_models/app/cms/index";
...
@Component({
  selector: "app-groupcriteria-edit",
  templateUrl: "./groupcriteria-edit.component.html",
  styleUrls: ["./groupcriteria-edit.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class GroupCriteriaEditComponent implements OnInit {
    ...
    async.waterfall(
      [
        (cb: any) => {
          if (this.paramId) {
            this._coreService
              .Get("hr/GroupCriteria/get?id=" + this.paramId)
              .subscribe((res: any) => {
    ...
    switch (buttonId) {
      case ToolbarItem.BACK:
        ...
        if (this.flagePopup === true) {
          this.router.navigate(["hrms/profile/list/GroupCriteria"]);
        }
        break;
  ...
  saveData = () => {
    ...
    if (this.flagState$.value === "new") {    
      this._coreService.Post("hr/GroupCriteria/add", param).subscribe(
        (res: any) => {
      ...
      this._coreService.Post("hr/GroupCriteria/Update", param).subscribe(
        (res: any) => {
